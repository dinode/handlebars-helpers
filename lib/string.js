...
helpers.replaceregex = (str, regex, replaceWith) => {
  if (!util.isString(str) || !util.isString(regex) || !util.isString(replaceWith)) {
    return "";
  }

  return str.replace(new RegExp(regex, "gi"), replaceWith);
}